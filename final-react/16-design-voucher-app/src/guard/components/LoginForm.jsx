...
const LoginForm = () => {
  return (
    <div className="mt-7 w-[400px] bg-white border border-gray-200 rounded-xl shadow-2xs">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    id="email"
                    name="email"
                    className="py-2.5 border sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                    required
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    id="password"
                    name="password"
                    className="py-2.5 sm:py-3 px-4 border block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                    required
