            ...
            <div className=" min-w-full inline-block align-middle">
              <div className="bg-white border border-gray-200 rounded-xl shadow-2xs overflow-hidden dark:bg-neutral-900 dark:border-neutral-700">
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                  ...
                  {
                    isLoading ? (<TableRowSkeletonLoader/>) : (
                      data?.data.length > 0 && data.data.map((product) => <ProductTableRow key={product.id} data={product}/>)
                    )
                  }
                ...
                {/* Footer */}
                    {
                      isLoading ? (<TableFooterSkeletonLoader/>) : (<ProductTableFooter data={data}/>)
                    }
                {/* End Footer */}
